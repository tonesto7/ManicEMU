...
public let kUTTypeDeltaControllerSkin: CFString = "public.aoshuang.skin" as CFString
...
public struct ControllerSkin: ControllerSkinBase
{
    ...
    public init?(fileURL: URL, initGameType: GameType? = nil, supportGameTypes: [GameType]? = nil)
    {
        ...
        do
        {
            ...
            self.isDebugMode = isDebugModeEnabled
