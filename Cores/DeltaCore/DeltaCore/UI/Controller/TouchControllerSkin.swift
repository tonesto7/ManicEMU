...
public struct TouchControllerSkin
{
    ...
    public var identifier: String { "com.aoshuang.TouchControllerSkin" }
    public var gameType: GameType { controllerSkin.gameType }
    public var isDebugMode: Bool { false }
    
    public var layoutAxis: LayoutAxis = .vertical
    public var screenPredicate: ((ControllerSkin.Screen) -> Bool)?
    
    private let controllerSkin: ControllerSkinBase
    
    public init(controllerSkin: ControllerSkinBase)
    {
        self.controllerSkin = controllerSkin
    }
}

extension TouchControllerSkin: ControllerSkinBase
{
